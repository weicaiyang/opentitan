...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_46_ds_h2d [19];
  tl_d2h_t tl_s1n_46_ds_d2h [19];

  // Create steering signal
  logic [4:0] dev_sel_s1n_46;
  ...
  assign tl_sm1_29_us_h2d[0] = tl_s1n_28_ds_h2d[1];
  assign tl_s1n_28_ds_d2h[1] = tl_sm1_29_us_d2h[0];

  assign tl_sm1_25_us_h2d[1] = tl_s1n_28_ds_h2d[2];
  assign tl_s1n_28_ds_d2h[2] = tl_sm1_25_us_d2h[1];

  assign tl_sm1_30_us_h2d[0] = tl_s1n_28_ds_h2d[3];
  assign tl_s1n_28_ds_d2h[3] = tl_sm1_30_us_d2h[0];

  assign tl_sm1_26_us_h2d[1] = tl_s1n_28_ds_h2d[4];
  assign tl_s1n_28_ds_d2h[4] = tl_sm1_26_us_d2h[1];

  assign tl_sm1_27_us_h2d[1] = tl_s1n_28_ds_h2d[5];
  assign tl_s1n_28_ds_d2h[5] = tl_sm1_27_us_d2h[1];
  ...
  assign tl_sm1_44_us_h2d[0] = tl_s1n_28_ds_h2d[18];
  assign tl_s1n_28_ds_d2h[18] = tl_sm1_44_us_d2h[0];

  assign tl_sm1_45_us_h2d[0] = tl_s1n_28_ds_h2d[19];
  assign tl_s1n_28_ds_d2h[19] = tl_sm1_45_us_d2h[0];

  assign tl_sm1_24_us_h2d[2] = tl_s1n_46_ds_h2d[0];
  assign tl_s1n_46_ds_d2h[0] = tl_sm1_24_us_d2h[2];

  assign tl_sm1_29_us_h2d[1] = tl_s1n_46_ds_h2d[1];
  assign tl_s1n_46_ds_d2h[1] = tl_sm1_29_us_d2h[1];

  assign tl_sm1_30_us_h2d[1] = tl_s1n_46_ds_h2d[2];
  assign tl_s1n_46_ds_d2h[2] = tl_sm1_30_us_d2h[1];

  assign tl_sm1_26_us_h2d[2] = tl_s1n_46_ds_h2d[3];
  assign tl_s1n_46_ds_d2h[3] = tl_sm1_26_us_d2h[2];

  assign tl_sm1_27_us_h2d[2] = tl_s1n_46_ds_h2d[4];
  assign tl_s1n_46_ds_d2h[4] = tl_sm1_27_us_d2h[2];

  assign tl_sm1_32_us_h2d[1] = tl_s1n_46_ds_h2d[5];
  assign tl_s1n_46_ds_d2h[5] = tl_sm1_32_us_d2h[1];

  assign tl_sm1_33_us_h2d[1] = tl_s1n_46_ds_h2d[6];
  assign tl_s1n_46_ds_d2h[6] = tl_sm1_33_us_d2h[1];

  assign tl_sm1_34_us_h2d[1] = tl_s1n_46_ds_h2d[7];
  assign tl_s1n_46_ds_d2h[7] = tl_sm1_34_us_d2h[1];

  assign tl_sm1_35_us_h2d[1] = tl_s1n_46_ds_h2d[8];
  assign tl_s1n_46_ds_d2h[8] = tl_sm1_35_us_d2h[1];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_46_ds_h2d[9];
  assign tl_s1n_46_ds_d2h[9] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_37_us_h2d[1] = tl_s1n_46_ds_h2d[10];
  assign tl_s1n_46_ds_d2h[10] = tl_sm1_37_us_d2h[1];

  assign tl_sm1_38_us_h2d[1] = tl_s1n_46_ds_h2d[11];
  assign tl_s1n_46_ds_d2h[11] = tl_sm1_38_us_d2h[1];

  assign tl_sm1_39_us_h2d[1] = tl_s1n_46_ds_h2d[12];
  assign tl_s1n_46_ds_d2h[12] = tl_sm1_39_us_d2h[1];

  assign tl_sm1_40_us_h2d[1] = tl_s1n_46_ds_h2d[13];
  assign tl_s1n_46_ds_d2h[13] = tl_sm1_40_us_d2h[1];

  assign tl_sm1_41_us_h2d[1] = tl_s1n_46_ds_h2d[14];
  assign tl_s1n_46_ds_d2h[14] = tl_sm1_41_us_d2h[1];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_46_ds_h2d[15];
  assign tl_s1n_46_ds_d2h[15] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_46_ds_h2d[16];
  assign tl_s1n_46_ds_d2h[16] = tl_sm1_43_us_d2h[1];

  assign tl_sm1_44_us_h2d[1] = tl_s1n_46_ds_h2d[17];
  assign tl_s1n_46_ds_d2h[17] = tl_sm1_44_us_d2h[1];

  assign tl_sm1_45_us_h2d[1] = tl_s1n_46_ds_h2d[18];
  assign tl_s1n_46_ds_d2h[18] = tl_sm1_45_us_d2h[1];

  assign tl_s1n_23_us_h2d = tl_corei_i;
  assign tl_corei_o = tl_s1n_23_us_d2h;

  assign tl_rom_ctrl__rom_o = tl_sm1_24_ds_h2d;
  assign tl_sm1_24_ds_d2h = tl_rom_ctrl__rom_i;

  assign tl_rv_dm__rom_o = tl_sm1_25_ds_h2d;
  assign tl_sm1_25_ds_d2h = tl_rv_dm__rom_i;
  ...
  assign tl_rom_ctrl__regs_o = tl_sm1_29_ds_h2d;
  assign tl_sm1_29_ds_d2h = tl_rom_ctrl__regs_i;

  assign tl_rv_dm__regs_o = tl_sm1_30_ds_h2d;
  assign tl_sm1_30_ds_d2h = tl_rv_dm__regs_i;

  assign tl_peri_o = tl_asf_31_ds_h2d;
  assign tl_asf_31_ds_d2h = tl_peri_i;
  ...
  assign tl_aes_o = tl_sm1_35_ds_h2d;
  assign tl_sm1_35_ds_d2h = tl_aes_i;

  assign tl_entropy_src_o = tl_sm1_36_ds_h2d;
  assign tl_sm1_36_ds_d2h = tl_entropy_src_i;

  assign tl_csrng_o = tl_sm1_37_ds_h2d;
  assign tl_sm1_37_ds_d2h = tl_csrng_i;

  assign tl_edn0_o = tl_sm1_38_ds_h2d;
  assign tl_sm1_38_ds_d2h = tl_edn0_i;

  assign tl_edn1_o = tl_sm1_39_ds_h2d;
  assign tl_sm1_39_ds_d2h = tl_edn1_i;

  assign tl_hmac_o = tl_sm1_40_ds_h2d;
  assign tl_sm1_40_ds_d2h = tl_hmac_i;

  assign tl_rv_plic_o = tl_sm1_41_ds_h2d;
  assign tl_sm1_41_ds_d2h = tl_rv_plic_i;

  assign tl_otbn_o = tl_sm1_42_ds_h2d;
  assign tl_sm1_42_ds_d2h = tl_otbn_i;

  assign tl_keymgr_o = tl_sm1_43_ds_h2d;
  assign tl_sm1_43_ds_d2h = tl_keymgr_i;

  assign tl_kmac_o = tl_sm1_44_ds_h2d;
  assign tl_sm1_44_ds_d2h = tl_kmac_i;

  assign tl_sram_ctrl_main_o = tl_sm1_45_ds_h2d;
  assign tl_sm1_45_ds_d2h = tl_sram_ctrl_main_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_46_us_h2d.a_address &
      ...
      dev_sel_s1n_46 = 5'd9;
                  ...
                  ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_46 = 5'd10;

    end else if ((tl_s1n_46_us_h2d.a_address &
                  ~(ADDR_MASK_EDN0)) == ADDR_SPACE_EDN0) begin
      dev_sel_s1n_46 = 5'd11;

    end else if ((tl_s1n_46_us_h2d.a_address &
                  ~(ADDR_MASK_EDN1)) == ADDR_SPACE_EDN1) begin
      dev_sel_s1n_46 = 5'd12;

    end else if ((tl_s1n_46_us_h2d.a_address &
                  ~(ADDR_MASK_HMAC)) == ADDR_SPACE_HMAC) begin
      dev_sel_s1n_46 = 5'd13;

    end else if ((tl_s1n_46_us_h2d.a_address &
                  ~(ADDR_MASK_RV_PLIC)) == ADDR_SPACE_RV_PLIC) begin
      dev_sel_s1n_46 = 5'd14;

    end else if ((tl_s1n_46_us_h2d.a_address &
                  ~(ADDR_MASK_OTBN)) == ADDR_SPACE_OTBN) begin
      dev_sel_s1n_46 = 5'd15;

    end else if ((tl_s1n_46_us_h2d.a_address &
                  ~(ADDR_MASK_KEYMGR)) == ADDR_SPACE_KEYMGR) begin
      dev_sel_s1n_46 = 5'd16;

    end else if ((tl_s1n_46_us_h2d.a_address &
                  ~(ADDR_MASK_KMAC)) == ADDR_SPACE_KMAC) begin
      dev_sel_s1n_46 = 5'd17;

    end else if ((tl_s1n_46_us_h2d.a_address &
                  ~(ADDR_MASK_SRAM_CTRL_MAIN)) == ADDR_SPACE_SRAM_CTRL_MAIN) begin
      dev_sel_s1n_46 = 5'd18;
end
  end
